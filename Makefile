...
CC = gcc
CFLAGS = -Wall -O2
FILES = $(TSH) ./myspin ./mysplit ./mystop ./myint ./mycounter
...
test1:
    $(DRIVER) -t trace1.txt -s $(TSH) -a $(TSHARGS)
test2:
    $(DRIVER) -t trace2.txt -s $(TSH) -a $(TSHARGS)
test3:
    $(DRIVER) -t trace3.txt -s $(TSH) -a $(TSHARGS)
